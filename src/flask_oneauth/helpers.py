...
def import_env(*args, **kwargs):
    """
    Import module attribute by name from the env
    >>> import_env("ONEAUTH_USER_MODEL", User)
    """
    name = get_env(*args, **kwargs)
    return import_attr(name) \
